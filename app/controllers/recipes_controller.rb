class RecipesController < ApplicationController
  ...
  def search
    ...
    if @course.blank?
      @url = URI::encode("https://api.yummly.com/v1/api/recipes?_app_id="+yumid+"&_app_key="+yumkey+"&q=#{@search}&maxTotalTimeInSeconds=#{@seconds}")
    else
      @url = URI::encode("https://api.yummly.com/v1/api/recipes?_app_id="+yumid+"&_app_key="+yumkey+"&q=#{@search}&allowedCourse[]=course^course-#{@course}&maxTotalTimeInSeconds=#{@seconds}")
    end
  ...
  def show
    ...
    @url_y = "https://api.yummly.com/v1/api/recipe/#{params[:id]}?_app_id="+yumid+"&_app_key="+yumkey
